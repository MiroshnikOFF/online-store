...
from catalog.views import HomeTemplateView, contacts, ProductListView, ProductCreateView, ProductUpdateView, \
    ProductDetailView, ProductDeleteView, get_versions_by_product, show_version, CategoryListView, publish_product
...
urlpatterns = [
    ...
    path('products/<int:pk>/published/', publish_product, name='product_published'),
